exports.BattleMovedex = {
    ...
    "watershuriken": {
        ...
        "category": "Special",
        "contestType": "Beauty",
        "desc": "Hits two to five times. Has a 35% chance to hit two or three times and a 15% chance to hit four or five times. If one of the hits breaks the target's substitute, it will take damage for the remaining hits. If the user has the Skill Link Ability or is Greninja, this move will always hit five times. If the user is an Ash-Greninja with the Battle Bond Ability, this move has a power of 20 and always hits three times.",
    ...
    "freezyfrost": {
        ...
        "priority": 0,
        "category": "Special",
        "desc": "Resets the stat stages of all active Pokemon to 0. Has a 100% chance to frostbite the target.",
        "shortDesc": "Eliminates all stat changes and inflicts Frostbite."
    },
    "sparklyswirl": {
        "num": 687,
        "flags": {
    ...
    "hydrosteam": {
        ...
        "priority": 0,
        "category": "Special",
        "desc": "If the current weather is Sunny Day or Desolate Land and the user is not holding Utility Umbrella, this move's damage is multiplied by 1.5 instead of halved for being Water type.",
